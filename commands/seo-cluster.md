---
description: "SERP-based semantic clustering and content architecture planning. Builds topic clusters, pillar page strategies, and content gap analysis from keyword research."
agent: general
---
The user ran /seo-cluster with argument: $ARGUMENTS
...
This is the core differentiator. Load `~/.config/opencode/seo-skills/seo-cluster/references/serp-overlap-methodology.md` for
the full algorithm.
...
Load `~/.config/opencode/seo-skills/seo-cluster/references/hub-spoke-architecture.md` for full specifications.
...
```
Test: Does ~/.config/opencode/skills/blog/SKILL.md exist?
```

**If claude-blog IS installed:**

1. Load `~/.config/opencode/seo-skills/seo-cluster/references/execution-workflow.md` for the full algorithm
