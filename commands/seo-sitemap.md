---
description: XML sitemap analysis, validation, and generation. Handles sitemap discovery, IndexNow submission, and structured sitemap creation.
agent: general
---
The user ran /seo-sitemap with argument: $ARGUMENTS
