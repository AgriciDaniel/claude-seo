---
description: AI image generation for SEO assets. Creates optimized images for blog posts, social sharing, product listings, and schema markup.
agent: general
---
The user ran /seo-image-gen with argument: $ARGUMENTS
...
4. **Construct Reasoning Brief** using the banana Creative Director pipeline:
   - Load `~/.config/opencode/seo-skills/seo-image-gen/references/prompt-engineering.md` for the 6-component system
...
```
Load matching preset and apply as defaults. Also check `~/.config/opencode/seo-skills/seo-image-gen/references/seo-image-presets.md`
...
| `IMAGE_SAFETY` | Rephrase prompt - see `~/.config/opencode/seo-skills/seo-image-gen/references/prompt-engineering.md` Safety section |
...
- `~/.config/opencode/seo-skills/seo-image-gen/references/prompt-engineering.md`:6-component system, domain modes, templates
- `~/.config/opencode/seo-skills/seo-image-gen/references/gemini-models.md`:Model specs, rate limits, capabilities
- `~/.config/opencode/seo-skills/seo-image-gen/references/mcp-tools.md`:MCP tool parameters and responses
- `~/.config/opencode/seo-skills/seo-image-gen/references/post-processing.md`:ImageMagick/FFmpeg pipeline recipes
- `~/.config/opencode/seo-skills/seo-image-gen/references/cost-tracking.md`:Pricing, usage tracking
- `~/.config/opencode/seo-skills/seo-image-gen/references/presets.md`:Brand preset management
- `~/.config/opencode/seo-skills/seo-image-gen/references/seo-image-presets.md`:SEO-specific preset templates
