---
description: "Search Experience Optimization. Performs SERP backwards analysis to detect page-type mismatches, derives user stories from intent signals, and scores pages from multiple persona perspectives."
agent: general
---
The user ran /seo-sxo with argument: $ARGUMENTS
...
Read `~/.config/opencode/seo-skills/seo-sxo/references/page-type-taxonomy.md` for classification rules.
...
- Classify target page using `~/.config/opencode/seo-skills/seo-sxo/references/page-type-taxonomy.md`
...
Read `~/.config/opencode/seo-skills/seo-sxo/references/user-story-framework.md` for the full framework.
...
Read `~/.config/opencode/seo-skills/seo-sxo/references/persona-scoring.md` for methodology.
...
Read `~/.config/opencode/seo-skills/seo-sxo/references/wireframe-templates.md` for templates.
