---
description: "Hreflang and international SEO audit. Validates language/region targeting, content parity across locales, cultural profile analysis, and hreflang tag generation."
agent: general
---
The user ran /seo-hreflang with argument: $ARGUMENTS
...
Load `~/.config/opencode/seo-skills/seo-hreflang/references/cultural-profiles.md` for pre-built profiles (DACH, Francophone, Hispanic, Japanese).
...
Load `~/.config/opencode/seo-skills/seo-hreflang/references/content-parity.md` for the full parity matrix and scoring methodology.
...
Load `~/.config/opencode/seo-skills/seo-hreflang/references/locale-formats.md` for number, date, currency, address, and phone format
...
- `~/.config/opencode/seo-skills/seo-hreflang/references/cultural-profiles.md`: DACH, Francophone, Hispanic, Japanese cultural adaptation profiles
- `~/.config/opencode/seo-skills/seo-hreflang/references/locale-formats.md`: Number, date, currency, address, phone format tables per locale
- `~/.config/opencode/seo-skills/seo-hreflang/references/content-parity.md`: Content parity audit methodology and scoring
