---
description: "E-commerce SEO analysis covering product schema, category architecture, faceted navigation, marketplace intelligence, and shopping feed optimization."
agent: general
---
The user ran /seo-ecommerce with argument: $ARGUMENTS
...
Load `~/.config/opencode/seo-skills/seo-ecommerce/references/marketplace-endpoints.md` for full API parameter details.
...
`~/.config/opencode/seo-skills/seo-ecommerce/references/ucp-universal-commerce-protocol.md` for audit criteria,
