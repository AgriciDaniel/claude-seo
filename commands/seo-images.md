---
description: Image SEO analysis covering alt text, file size, format optimization, lazy loading, dimensions, and SERP image visibility.
agent: general
---
The user ran /seo-images with argument: $ARGUMENTS
