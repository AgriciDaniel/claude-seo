---
description: Detailed SEO content brief generation covering target keywords, content outline, internal linking strategy, and competitive content analysis.
agent: general
---
The user ran /seo-content-brief with argument: $ARGUMENTS
...
- Filter out non-competitors (Wikipedia, Reddit, Pinterest, Amazon, YouTube, government sites, SEO tool pages, job boards, directories, news aggregators, social platforms). See `~/.config/opencode/seo-skills/seo-content-brief/references/excluded-domains.md` for the full list.
...
Apply the page-type template from `~/.config/opencode/seo-skills/seo-content-brief/references/page-type-templates.md`, then customise based on competitor gaps and search intent.
...
Read `~/.config/opencode/seo-skills/seo-content-brief/references/keyword-density.md` for the full rules. Summary:
