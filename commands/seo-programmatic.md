---
description: Programmatic SEO analysis and planning. Covers template design, data source identification, URL structure, and scaling strategies for programmatic content.
agent: general
---
The user ran /seo-programmatic with argument: $ARGUMENTS
