---
description: "Detect, validate, and generate Schema.org structured data. JSON-LD format preferred. Covers all Google-supported rich result types and AI-citation schema."
agent: general
---
The user ran /seo-schema with argument: $ARGUMENTS
...
Read `~/.config/opencode/seo-skills/seo-schema/references/schema-types.md` for the full list. Key rules:
...
See `~/.config/opencode/seo-skills/schema/templates.json` for ready-to-use JSON-LD templates for these types.
