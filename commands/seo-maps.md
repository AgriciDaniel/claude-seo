---
description: "Maps intelligence covering geo-grid rank tracking, Google Business Profile audit, local competitor analysis, and review monitoring."
agent: general
---
The user ran /seo-maps with argument: $ARGUMENTS
...
**Load:** `~/.config/opencode/seo-skills/references/maps-free-apis.md`
...
**Load:** `~/.config/opencode/seo-skills/references/maps-api-endpoints.md`
...
**Load:** `~/.config/opencode/seo-skills/references/maps-geo-grid.md` for algorithm, SoLV formula, heatmap format.
**Load:** `~/.config/opencode/seo-skills/references/maps-api-endpoints.md` for Maps SERP endpoint details.
...
**Load:** `~/.config/opencode/seo-skills/references/maps-gbp-checklist.md` for full checklist and scoring.
...
**Reference:** `~/.config/opencode/seo-skills/references/local-seo-signals.md` for benchmarks (shared with seo-local).
...
**Load:** `~/.config/opencode/seo-skills/references/maps-free-apis.md` for query templates.
...
**Reference:** `~/.config/opencode/seo-skills/references/local-schema-types.md` for industry subtypes (shared with seo-local).
...
- `~/.config/opencode/seo-skills/references/maps-api-endpoints.md`: DataForSEO endpoint details, params, costs
- `~/.config/opencode/seo-skills/references/maps-free-apis.md`: Overpass, Geoapify, Nominatim query templates
- `~/.config/opencode/seo-skills/references/maps-geo-grid.md`: Grid algorithm, SoLV formula, heatmap rendering
- `~/.config/opencode/seo-skills/references/maps-gbp-checklist.md`: 25-field GBP audit with industry weights
- `~/.config/opencode/seo-skills/references/local-seo-signals.md`: Ranking factors, review benchmarks (shared)
- `~/.config/opencode/seo-skills/references/local-schema-types.md`: LocalBusiness subtypes by industry (shared)
