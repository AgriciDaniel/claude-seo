---
description: "Local SEO analysis covering Google Business Profile, local citations, NAP consistency, review signals, and map pack visibility."
agent: general
---
The user ran /seo-local with argument: $ARGUMENTS
...
Detect from page signals and GBP category patterns. Routes to industry-specific checks from `~/.config/opencode/seo-skills/references/local-schema-types.md`.
...
- Industry-specific directory recommendations: load `~/.config/opencode/seo-skills/references/local-schema-types.md` for per-vertical citation sources
...
- **Correct subtype for industry** -- load `~/.config/opencode/seo-skills/references/local-schema-types.md`:
...
- Industry-specific schema patterns (per `~/.config/opencode/seo-skills/references/local-schema-types.md`):
...
- `~/.config/opencode/seo-skills/references/local-seo-signals.md`: Ranking factors, review benchmarks, citation tiers, GBP feature status, algorithm updates
- `~/.config/opencode/seo-skills/references/local-schema-types.md`: LocalBusiness subtypes by industry, schema patterns, citation sources per vertical
