---
description: "Google SEO APIs integration covering Search Console, PageSpeed Insights, CrUX, Indexing API, and Google Analytics 4."
agent: general
---
The user ran /seo-google with argument: $ARGUMENTS
...
If missing, read `~/.config/opencode/seo-skills/seo-google/references/auth-setup.md` and walk the user through setup.
...
**Reference:** `~/.config/opencode/seo-skills/seo-google/references/pagespeed-crux-api.md`
...
**Reference:** `~/.config/opencode/seo-skills/seo-google/references/search-console-api.md`
...
**Reference:** `~/.config/opencode/seo-skills/seo-google/references/indexing-api.md`
...
**Reference:** `~/.config/opencode/seo-skills/seo-google/references/ga4-data-api.md`
...
**Reference:** `~/.config/opencode/seo-skills/seo-google/references/youtube-api.md`
...
**Reference:** `~/.config/opencode/seo-skills/seo-google/references/nlp-api.md`
...
**Reference:** `~/.config/opencode/seo-skills/seo-google/references/keyword-planner-api.md`
...
**Reference:** `~/.config/opencode/seo-skills/seo-google/references/supplementary-apis.md`
...
Display rate limits table. Read `~/.config/opencode/seo-skills/seo-google/references/rate-limits-quotas.md`.
