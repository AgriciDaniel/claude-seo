---
description: "SEO drift monitoring. Captures baselines, compares current state, and tracks SEO metric changes over time using the drift SQLite database."
agent: general
---
The user ran /seo-drift with argument: $ARGUMENTS
...
`~/.config/opencode/seo-skills/seo-drift/references/comparison-rules.md` for the full rule set with thresholds,
