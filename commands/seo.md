...
agent: general
---
The user ran /seo with arguments: $ARGUMENTS
...
Full methodology + per-principle SEO mapping: `~/.config/opencode/seo-skills/references/thinking-framework.md`.
...
Read `~/.config/opencode/seo-skills/references/quality-gates.md` for thin content thresholds per page type.
Hard rules:
...
- `~/.config/opencode/seo-skills/references/cwv-thresholds.md`: Current Core Web Vitals thresholds and measurement details
- `~/.config/opencode/seo-skills/references/schema-types.md`: All supported schema types with deprecation status
- `~/.config/opencode/seo-skills/references/eeat-framework.md`: E-E-A-T evaluation criteria (Sept 2025 QRG update)
- `~/.config/opencode/seo-skills/references/quality-gates.md`: Content length minimums, uniqueness thresholds
- `~/.config/opencode/seo-skills/references/local-seo-signals.md`: Local ranking factors, review benchmarks, citation tiers, GBP status
- `~/.config/opencode/seo-skills/references/local-schema-types.md`: LocalBusiness subtypes, industry-specific schema and citation sources

Maps-specific references (loaded by seo-maps skill, not at startup):
- `~/.config/opencode/seo-skills/references/maps-geo-grid.md`, `~/.config/opencode/seo-skills/references/maps-gbp-checklist.md`, `~/.config/opencode/seo-skills/references/maps-api-endpoints.md`, `~/.config/opencode/seo-skills/references/maps-free-apis.md`
