...
- Optional `seo-xquik` extension for bounded, read-only public X-post and topic
  research. Results feed the LISTEN workflow as untrusted audience evidence,
  never as a direct search ranking signal.
